...
void Boss::display(HANDLE & hOutputHandle)
{
	...
	int offset_x = coordDisplayPos.X - BossGraph.centerPos.X;
	int offset_y = coordDisplayPos.Y - BossGraph.centerPos.Y;
